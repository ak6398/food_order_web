    ...
    <div class="container">
       ...
       <div class="row">
         ...
         @php
             ...
             $coupon=App\Models\Coupon::where('client_id',$client->id)->where('status','1')->first();
         @endphp
                   ...
                   <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                      ...
                      <div class="p-3 position-relative">
                         ...
                         <div class="list-card-badge">
                           @if ($coupon)
                           <span class="badge badge-success">OFFER</span> <small>{{$coupon->discount}}%off | Use Coupon {{$coupon->coupon_name}}</small>
                           @else
                           <span class="badge badge-warning">Sorry</span> <small>Right now There have no coupon</small>
                           @endif
